...
version of the federal endangered and threatened species listings.

`te_check()` generates a list of species you should consider removing
...
`te_check()` should be considered a helpful tool for identifying
...
The `te_check()` function downloads the Federal Conservation list using
